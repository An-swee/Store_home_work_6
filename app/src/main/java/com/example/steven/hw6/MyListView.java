...
public class MyListView extends ListView implements View.OnTouchListener,GestureOverlayView.OnGestureListener {
    /**
     * 手势识别类
     */
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
        ...
        if (!isDeleteShow && Math.abs(velocityX) > Math.abs(velocityY)) {
            ...
            btnDelete = LayoutInflater.from(getContext()).inflate(R.layout.button, null);
